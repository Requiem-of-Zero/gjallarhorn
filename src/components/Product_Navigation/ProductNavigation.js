...
const ProductNavigation = ({ setActive, active, setFiltered, products }) => {
  ...
  return (
    <div className="product_navigation m0a bg-grey text-grey scrollbar-hide z-10 flex w-full whitespace-nowrap border-b border-t border-[#1F2122] border-solid top-header lg:top-header-desktop sticky top-[47px] max-w-contentContainer sml:justify-center lgl:top-[119px]">
